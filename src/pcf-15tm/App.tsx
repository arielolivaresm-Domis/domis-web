...
// import { GoogleGenerativeAI } from "@google/generative-ai"; // IA DESACTIVADA TEMPORALMENTE
...
const App: React.FC = () => {
  ...
  const handleGenerateAuditId = async () => {
    ...
    // IA TEMPORALMENTE DESACTIVADA - Generando ID aleatorio
  ...
  const generateDescription = async () => {
    ...
    setPortalDesc(`Propiedad ubicada en ${property.address}. ${property.type} de ${property.m2Useful}m² útiles. Características: ${amenities || 'A definir'}.`);
         ...
         <div className="bg-slate-900/40 border border-slate-700 rounded-lg p-4">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                 ...
                 <div className="bg-blue-900/20 border border-blue-500/30 p-3 rounded">
                    <label className="block text-xs font-bold text-blue-400 uppercase mb-1">🤝 Honorario Éxito (15% Ahorro)</label>
