// ICONO: SISTEMA ELÉCTRICO / ENERGÍA
...
// ICONO: REDES SANITARIAS / HUMEDAD / GAS
...
// ICONO: PLANIMETRÍA / DIMENSIONES / ARQUITECTURA
export const IconRuler = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <line x1="13" y1="7" x2="14" y2="8"></line>
    <line x1="9" y1="11" x2="10" y2="12"></line>
    <line x1="5" y1="15" x2="6" y2="16"></line>
    <line x1="17" y1="3" x2="18" y2="4"></line>
  </svg>
);

// ICONO: TERMOGRAFÍA / CLIMATIZACIÓN / PUENTES TÉRMICOS
export const IconThermo = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M14 14.76V3.5a2.5 2.5 0 0 0-5 0v11.26a4.5 4.5 0 1 0 5 0z"></path>
  </svg>
);

// ICONO: ESCÁNER DE ENTORNO / VICIOS ESTRUCTURALES
