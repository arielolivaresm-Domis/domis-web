...
export default function Footer() {
  return (
    ...
    <footer className="relative z-20 bg-slate-950 border-t border-white/5 pt-24 pb-12 font-sans overflow-hidden">
      ...
      <Section className="relative z-10 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-slate-400 text-base leading-relaxed max-w-sm mb-8 font-medium">
          ...
          <div>
            <h4 className="text-white font-black uppercase tracking-[0.2em] text-[12px] mb-8 border-b border-white/10 pb-2 w-fit">
              Navegación
            </h4>
            <ul className="space-y-4 text-[14px] text-slate-400 font-bold uppercase tracking-tight">
      ...
      <Section containerClass="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left">
          ...
          <p className="text-cyan-500/50 text-[10px] font-black uppercase tracking-widest">
            Powered by PCF-15™ Engine
          </p>
        </div>
        <p className="text-slate-700 text-[10px] font-mono uppercase font-black tracking-[0.3em] hover:text-slate-500 transition-colors cursor-default">
