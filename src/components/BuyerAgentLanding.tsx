  ...
  en: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'How much does a buyer\'s agent cost in Chile?', a: 'DOMIS™ has a fee structure differentiated by phase. Phase 1 (technical audit) is priced per square meter with a $70,000 CLP + VAT minimum (35m² floor). Phase 2 (negotiation) is structured on results. Contact us for your specific case.' },
  ...
  es: {
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Cuánto cuesta el servicio?', a: 'DOMIS™ tiene estructura de honorarios por fase. La Fase 1 (auditoría) se cotiza por metro cuadrado con mínimo facturable de $70.000 + IVA (35m²). La Fase 2 (negociación) se estructura sobre el resultado. Escríbenos para cotizar tu caso.' },
