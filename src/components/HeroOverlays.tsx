...
// --- HOJA 1: EL GANCHO DE NEGOCIOS (AJUSTE DE ESPACIOS) ---
export function HeroHook({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    ...
    >
      {/* TEXTO SUPERIOR: BAJADO 2 LÍNEAS EN MÓVIL (pt-24 y mt-4) */}
      <div className="text-left relative z-10 pointer-events-auto max-w-3xl mt-4 md:mt-10">
        ...
        <div className="mb-10">
          ...
          <p className="text-slate-200 text-xl md:text-2xl font-medium max-w-xl leading-snug">
            en tu inversión con nuestro sistema de Auditoría Técnica y Estrategia de Negociación.
          </p>
        </div>
      </div>

      {/* TARJETA DE ACCIÓN: SUBIDA 7 LÍNEAS (vía pb-32 en el padre y mb-10) */}
      <div className="flex justify-end items-end w-full mb-10 md:mb-0">
...
// --- HOJA 2: EL INFORME TÉCNICO (MANTENIDO SIN CAMBIOS) ---
