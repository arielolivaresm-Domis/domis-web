...
// --- HOJA 1: EL GANCHO DE NEGOCIOS (CON BOX HIGHLIGHT PARA AHORRO) ---
export function HeroHook({ scrollYProgress }: { scrollYProgress: MotionValue<number> }) {
  ...
  return (
    ...
    >
      {/* TEXTO SUPERIOR: TITULAR COMPACTO */}
      <div className="text-left relative z-10 pointer-events-auto max-w-3xl mt-4 md:mt-10">
        <h1 className="text-5xl md:text-7xl font-black text-white leading-[0.85] mb-6 uppercase tracking-tighter">
          NO COMPRES <br />
        ...
        <div className="mb-6">
          {/* FRASE CON BOX HIGHLIGHT PARA CONTRASTE ABSOLUTO */}
      ...
      {/* TARJETA DE ACCIÓN: ELEVADA PARA MÓVIL (mb-32) */}
        ...
        <div className="bg-slate-950/90 backdrop-blur-xl p-8 border border-white/10 rounded-2xl shadow-2xl pointer-events-auto max-w-sm w-full relative z-20">
          ...
          <div className="space-y-4 my-6">
            <input 
                ...
                className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#F59E0B] transition-colors"
            />
            <input 
                type="tel" 
                id="telefono" 
...
// --- HOJA 2: INFORME TÉCNICO (DETALLE PCF-15) ---
