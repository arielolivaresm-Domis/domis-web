                ...
                {[
                  ...
                  <div key={pack.id} className={`flex flex-col gap-3 ${idx !== 0 ? 'border-t border-white/5 pt-4' : ''}`}>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3 text-slate-400 font-bold text-sm md:text-base">
                        ...
                        <ArrowRight size={14} className="text-slate-600" />
                        <span className="text-white bg-slate-800 px-3 py-1 rounded border border-slate-700 text-xs">Auditamos {pack.eliges}</span>
                      </div>
                    </div>
                    <div className="flex justify-between items-center border-t border-slate-800/50 pt-2">
                      <span className="text-cyan-500/80 text-xs font-bold uppercase tracking-tight">Inversión Sourcing: ${pack.inversion}</span>
                ...
                {[
                  ...
                  <div key={pack.id} className={`flex flex-col gap-3 ${idx !== 0 ? 'border-t border-cyan-500/20 pt-4' : ''}`}>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2.5 text-slate-300 font-bold text-sm md:text-base">
                        <span>Buscamos <span className="text-cyan-400">{pack.buscamos}</span></span>
                        <ArrowRight size={14} className="text-cyan-500/40" />
                        <span>Visitamos <span className="text-cyan-400">{pack.visitamos}</span></span>
                        <ArrowRight size={14} className="text-cyan-500/40" />
                        <span className="text-white bg-cyan-900/50 border border-cyan-500/30 px-3 py-1 rounded text-xs">Auditamos {pack.auditamos}</span>
                      </div>
                    </div>
                    <div className="flex justify-between items-center border-t border-cyan-500/20 pt-2">
                      <span className="text-cyan-400 text-xs font-bold uppercase tracking-tight">Inversión Sourcing: ${pack.inversion}</span>
