...
export default function BenefitFlyer() {
  ...
  // Manejar el cambio de cantidad de propiedades
  const handleCountChange = (count: number) => {
    setPropCount(count);
    setDomisCodes(Array(count).fill(''));
  };

  // Manejar el cambio en los inputs de códigos
      ...
      <div className="relative z-[100000] w-full max-w-md bg-slate-900 border-2 border-cyan-500 rounded-[2.5rem] p-8 shadow-[0_0_60px_rgba(34,211,238,0.3)] animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="text-left">
            ...
            <input required type="text" value={nombre} onChange={(e) => setNombre(e.target.value)} className="w-full bg-slate-950 border border-slate-800 p-4 rounded-xl text-white outline-none focus:border-cyan-500 transition-all" placeholder="Ej: Ariel..." />
          </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[1, 2, 3].map((num) => (
                <button
                  ...
                  className={`py-3 rounded-xl font-black transition-all border ${propCount === num ? 'bg-cyan-500 text-slate-950 border-cyan-500' : 'bg-slate-950 text-slate-500 border-slate-800'}`}
                >
                  {num}
                </button>
              ))}
          ...
          <div className="space-y-3">
            <label className="block text-[10px] uppercase text-cyan-500 font-black mb-1 tracking-widest text-left">Ingresar Códigos DOMIS™</label>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="relative rounded-[2.5rem] overflow-hidden border-2 border-cyan-500 shadow-[0_0_40px_rgba(34,211,238,0.2)] min-h-[600px] flex items-center justify-center bg-slate-900">
          ...
          <div className="absolute inset-0">
            <img src="/DOMIS_negotiation_bg.webp" alt="Negociación DOMIS" className="w-full h-full object-cover opacity-80 grayscale-[0.2] contrast-110" />
          ...
          <div className="relative z-10 p-8 md:p-16 flex flex-col items-center text-center max-w-4xl w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full mb-12 text-left">
              <div className="bg-slate-950/80 backdrop-blur-md border border-slate-700 p-6 rounded-2xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-black text-white uppercase">Fee Inicial</h3>
                </div>
              ...
              <div className="bg-slate-950/80 backdrop-blur-md border border-slate-700 p-6 rounded-2xl">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-black text-white uppercase">Éxito Final</h3>
                </div>
            ...
            <div className="mb-12">
              ...
              <p className="text-white font-black text-[10px] uppercase tracking-[0.4em]">En tu Auditoría al activar Fase 2</p>
            </div>

            <button 
              onClick={() => setIsModalOpen(true)}
              className="group inline-flex items-center gap-4 px-12 py-6 bg-white text-slate-950 font-black rounded-2xl uppercase tracking-[0.15em] text-sm hover:scale-105 transition-all shadow-2xl active:scale-95"
            >
